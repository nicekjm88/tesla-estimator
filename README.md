...
Install dependencies with `npm install` (or `yarn`, `pnpm`, etc.) before running tests. Then execute the Jest suite using:

```bash
npm test
```

Babel and Jest configuration files are already included.
